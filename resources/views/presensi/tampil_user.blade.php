            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    @for($i=date("Y"); $i>=$tahun_awal; $i--)
                        <li><a href="/tampil_presensi/{{$i}}/{{$bulan}}">{{$i}}</a></li>
                    @endfor
                </ul>
            </div>
             <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="/tampil_presensi/{{$tahun}}/01">Januari</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/02">Februari</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/03">Maret</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/04">April</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/05">Mei</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/06">Juni</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/07">Juli</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/08">Agustus</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/09">September</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/10">Oktober</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/11">November</a></li>
                    <li><a href="/tampil_presensi/{{$tahun}}/12">Desember</a></li>
                </ul>
            </div>
